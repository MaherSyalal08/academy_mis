              ...
              <div class="row">
                <form method="POST" action="{{ route('mahasiswaStore') }}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nrp" id="nrp" placeholder="e.g. 720001" required autofocues maxlength="7"/>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="address" id="address" placeholder="e.g. Jalan Surya Sumantri" required/>
                  </div>
